...
export class HeaderComponent implements OnInit {
  ...
  productsAll: any = [
    ...
    },
    {
      id: 8266462265661,
      title:
        'AIRSEP Kit - Mercrusier 1.7L -Kit # 90-1372  10.00% Off Auto renew',
    ...
    },
    {
      id: 8266462134589,
      title:
        'AIRSEP Air Filter (9Dia x 9L) Tapered -Part# CD196  10.00% Off Auto renew',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['CD 196', 'CD196', 'Subscription'],
      variants: [
        {
          id: 45127346684221,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462953789,
      title:
        'AIRSEP Air Filter (7.5 Dia x 9L) Cummins 6CTA -Part# CD177  10.00% Off Auto renew',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['CD 177', 'CD177', 'Subscription'],
      variants: [
        {
          id: 45127347896637,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462789949,
      title:
        'AIRSEP Air Filter (7.5 Dia x 8L) Cummins 6CTA -Part# CD176  10.00% Off Auto renew',
      handle:
        'copy-of-airsep-air-filter-7-5-dia-x-9l-cummins-6cta-part-cd177-3',
      body_html:
        '\u003cp\u003eWARNING: This product is for Recharge Subscriptions use  only, do not publish or delete this product. Customers will not see this message.\u003c/p\u003e',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['3866468', 'CD 176', 'CD176', 'Subscription'],
      variants: [
        {
          id: 45127347765565,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462757181,
      title:
        'AIRSEP Air Filter (7.5 Dia x 7L) Cummins 6BTA -Part# CD175  10.00% Off Auto renew',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['3897148', 'cd 175', 'cd175', 'Subscription'],
      variants: [
        {
          id: 45127347732797,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462331197,
      title:
        'AIRSEP Air Filter (7.5 Dia x 8L) Tapered -Part# CD195  10.00% Off Auto renew',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['4P-7918', '4P7918', 'CD 195', 'CD195', 'Subscription'],
      variants: [
        {
          id: 45127347011901,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462495037,
      title:
        'AIRSEP Air Filter (12Dia x 8L) Straight -Part# CD187  10.00% Off Auto renew',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['12 X 8', 'CD187', 'Subscription'],
      variants: [
        {
          id: 45127347175741,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462691645,
      title:
        'AIRSEP Air Filter (7.5 Dia x 6L) Cummins 6BTA -Part# CD174  10.00% Off Auto renew',
      handle:
        'copy-of-airsep-air-filter-7-5-dia-x-7l-cummins-6bta-part-cd175-3',
      body_html:
        '\u003cp\u003eWARNING: This product is for Recharge Subscriptions use  only, do not publish or delete this product. Customers will not see this message.\u003c/p\u003e',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['3866492', 'CD 174', 'CD174', 'Subscription'],
      variants: [
        {
          id: 45127347667261,
          title: 'Default Title',
    ...
    },
    {
      id: 8266462658877,
      title:
        'AIRSEP Air Filter (7.5 Dia x 5L) Cummins 4BTA-6BTA -Part# CD173  10.00% Off Auto renew',
      handle:
        'copy-of-airsep-air-filter-7-5-dia-x-7l-cummins-6bta-part-cd175-2',
      body_html:
        '\u003cp\u003eWARNING: This product is for Recharge Subscriptions use  only, do not publish or delete this product. Customers will not see this message.\u003c/p\u003e',
      published_at: '2023-05-17T14:56:55-04:00',
      ...
      vendor: 'Walker AIRSEP Air Filter',
      product_type: 'Replacement Air Filter AIRSEP Traditional',
      tags: ['4BTA', '6BTA', 'CD 173', 'CD173', 'Subscription'],
      variants: [
        {
          id: 45127347634493,
          title: 'Default Title',
    ...
    },
    {
      id: 8266461675837,
      title:
        'AIRSEP Air Filter (13 Dia x 7L) Alaska Diesel 6125 -Part# 40-1037  10.00% Off Auto renew',
      ...
      tags: ['40-1037', '401037', 'Caterpillar', 'Subscription'],
      variants: [
        {
          id: 45127346061629,
          title: 'Default Title',
    ...
    },
    {
      id: 8266461610301,
      title:
        'AIRSEP Air Filter (12Dia x 10L) Straight -Part# CD204  10.00% Off Auto renew',
    ...
    },
    {
      id: 8266461544765,
      title:
        'AIRSEP Air Filter  (7.5 Dia x 10L) Tapered -Part# CD190  10.00% Off Auto renew',
    ...
    },
    {
      id: 8266462527805,
      title:
        'AIRSEP Air Filter (12Dia x 7L) Straight -Part# CD186  10.00% Off Auto renew',
    ...
    },
    {
      id: 8266462462269,
      title:
        'AIRSEP Air Filter (12Dia x 6L) Straight -Part# CD203  10.00% Off Auto renew',
    ...
    },
    {
      id: 8274933416253,
      title:
        'CCV Air Filter (8.78 Dia x 10.32L) Closed End Filter -Part# 40-1195  10.00% Off Auto renew',
    ...
    },
    {
      id: 8274938593597,
      title:
        'CCE FIELD SERVICE KIT 8" AIRSEP COALESCER 2 PAK -Part# 1002032  10.00% Off Auto renew',
    ...
    },
    {
      id: 8274933645629,
      title:
        'CCE FIELD SERVICE KIT 8" AIRSEP (Cummins QSC) -Part# 1000267  10.00% Off Auto renew',
    ...
    },
    {
      id: 8274932957501,
      title:
        'CCE FIELD SERVICE KIT 8" AIRSEP (Cummins QSB) -Part# 1000266  10.00% Off Auto renew',
    ...
    },
    {
      id: 8274933186877,
      title:
        'CCV Air Filter (7.15 Dia x 10.25L) Closed End Filter -Part# 40-1194  10.00% Off Auto renew',
    ...
    },
    {
      id: 8274938265917,
      title:
        'CCE FIELD SERVICE KIT 12" AIRSEP COALESCER 2 PAK -Part# 1000821 10.00% Off Auto renew',
    ...
    },
    {
      id: 8274940395837,
      title:
        'CCE FIELD SERVICE KIT 10" XL AIRSEP COALESCER 2 PAK -Part# 1002332 (3") 10.00% Off Auto renew',
    ...
    },
    {
      id: 8274939642173,
      title:
        'CCE FIELD SERVICE KIT 10" XL AIRSEP COALESCER 2 PAK -Part# 1002300 (4") 10.00% Off Auto renew',
    ...
    },
    {
      id: 8274937119037,
      title:
        'CCE FIELD SERVICE KIT 10" x 14"  Tapered CCE Air Filter 2 PAK -Kit # 1001139 10.00% Off Auto renew',
      handle:
        'cce-field-service-kit-10-x-14-tapered-cce-air-filter-2-pak-kit-1001142',
      body_html:
        '\u003cp\u003eWARNING: This product is for Recharge Subscriptions use  only, do not publish or delete this product. Customers will not see this message.\u003c/p\u003e',
  ...
  productSearch() {
    ...
    console.log(this.productsAll.length);
